...
public class Documentation {
    ...
    private void writeComments(final BufferedWriter writer) throws IOException {
        ...
        writer.write("aus der Ausbildung so zugeordnet, dass eine inhaltliche und umfängliche Abdeckung unserer ");
        writer.write("Module hinreichend gewährleistet ist. Allgemein wird eine Abdeckung von 80\\% als vollkommen ");
        writer.write("ausreichend für eine Äquivalenzprüfung betrachtet. Bei einer Abdeckung zwischen 60\\% und ");
        writer.write("80\\% wird es allgemein als eine Ermessensentscheidung angesehen, inwiefern die ");
        ...
        writer.write("spezifische Abdeckungsmengen einhalten zu müssen. Dabei ist die Hochschule für die Einhaltung ");
        writer.write("ihrer eigenen Qualitätsstandards verantwortlich. Deshalb wurden die vorliegenden ");
        writer.write("Abdeckungseinschätzungen von den jeweils angegebenen modulverantwortlichen Personen inhaltlich ");
        writer.write("geprüft.\n\n");
        ...
        writer.write("zu vermittelnden Kompetenzen betrachtet.\n\n");
